...
import filters from "../es5/filters";
...
describe("filters", () => {
  it("should remove acronyms", () => {
    ...
    expect(filteredList).to.deep.equal([ { word: "AIs", index:0 }, { word: "COntains", index:0 },
      { word: "contaiNS", index:0 }]);
  });
  ...
  it("should remove numbers", () => {
    ...
    expect(filteredList).to.deep.equal([ { word: "A1", index:0 }, { word: "1A", index:0 }]);
  });
});